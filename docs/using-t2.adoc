...
|spec.orchestrator.openstackFlavorName |(optional) 'Flavor' of the instance in OpenStack | not available | not available | defaults to `8C-16GB-60GB`
...
|spec.nodes.<type>.openstackFlavorName |(optional) 'Flavor' of the instance in OpenStack | not available | not available | defaults to `2C-4GB-20GB`

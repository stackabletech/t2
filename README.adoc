...
|spec.cpuFamily |(optional) specify CPU-Family for the nodes of the given type. Values: "AMD_OPTERON" or "INTEL_XEON". If not provided, the default of the IONOS cloud applies.

...
public class SwaggerUiConfig {
	...
	SwaggerUiConfig(@Value("${t2.build.version}") String buildVersion,
	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI()
				...
				.info(new Info()
						...
						.contact(new Contact().name("Stackable GmbH").url("https://www.stackable.de").email("info@stackable.de"))
						.license(new License().name("Apache License 2.0").url("http://www.apache.org/licenses/LICENSE-2.0")));
	}
}
